...
if(!$conexion){
    ...
    $datos = $conexion->query("SELECT * FROM hoja_trabajo");
}
?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <body>
        ...
        <ul class="tabs tabs-fixed-width tab-demo z-depth-1">
            <li class="tab"><a href="#tab1" class="white-text">Pendientes</a></li>
        ...
        <div id="tab2" class="col s12">
            <div class="container">
                ...
                <ul class="collection">
                    ...
                    $datos2 = $conexion->query("SELECT idioma.nombre AS nombre, nivel.nivel AS nivel  FROM hoja_trabajo JOIN nivel JOIN idioma WHERE hoja_trabajo.id_nivel = nivel.id_nivel AND nivel.id_idioma = idioma.id_idioma ");
